...
<body>
    ...
    <div id="tela-alterar" class="tela">
        <div>
            ...
            <div class="tela-content">
                <form action="altclass.php" method="POST">
    ...
    <div class="lista-content">
        <button class="select-btn" onclick="mostrarListaUsuarios()" id="btn-lista">Lista de Classificação</button>
        ...
        <form action="CadClassificacao.php" method="POST" class="form-list">
        ...
        <table>
            ...
            <tr>
                ...
                if ((isset($_POST['pesquisar'])) or (isset($_POST['register']))) {
                    ...
                    $consulta = "SELECT codigo, nome FROM classificacao";
